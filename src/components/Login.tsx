      ...
      <div className="login-card">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="form-group">
            <label htmlFor="email">
              <svg style={{ width: '18px', height: '18px', display: 'inline', marginRight: '0.5rem' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          >
            {loading ? (
              <>
                <svg className="spinner-icon" style={{ width: '18px', height: '18px', marginRight: '0.5rem' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
