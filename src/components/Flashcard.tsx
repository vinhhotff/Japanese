    ...
    return (
      <div className="flashcard-container">
        <div className="flashcard-complete">
          <svg className="complete-icon" style={{ width: '80px', height: '80px', margin: '0 auto 1.5rem', color: '#10b981' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="flashcard-header">
        ...
        <div className="flashcard-stats">
          <span className="stat-badge mastered">
            <svg style={{ width: '14px', height: '14px', display: 'inline', marginRight: '0.25rem' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
