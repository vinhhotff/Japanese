...
const Header = () => {
  ...
  const handleSignOut = async () => {
    setShowUserMenu(false); // Close menu immediately for better UX
    await signOut();
    navigate('/');
  };
      ...
      <div className="header-container">
        ...
        <nav className="header-nav">
          ...
          <div className="nav-dropdown" ref={moreMenuRef}>
            <button
              className={`nav-link nav-dropdown-toggle ${showMoreMenu || isActiveGroup(['/saved-words', '/study-progress', '/forum', '/peer-matching']) ? 'active' : ''}`}
              onClick={() => {
            ...
            {showMoreMenu && (
              <div className="nav-dropdown-menu">
                ...
                <Link to="/forum" className="dropdown-item" onClick={() => setShowMoreMenu(false)}>
                  <svg className="dropdown-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                {user && (
                  <Link to="/peer-matching" className="dropdown-item" onClick={() => setShowMoreMenu(false)}>
                    <svg className="dropdown-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="header-actions">
            ...
            <div className="user-menu" ref={userMenuRef}>
              ...
              {showUserMenu && (
                <div className="user-menu-dropdown">
                  ...
                  {isTeacher && (
                    <Link to="/teacher-dashboard" className="user-menu-item" onClick={() => setShowUserMenu(false)}>
                      <svg className="dropdown-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          {/* Header Actions - Login for Guests */}
          {
            !user && (
